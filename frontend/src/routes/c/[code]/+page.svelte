...
<div class="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
	{#if loading}
		...
		<p class="mt-4 text-slate-500 dark:text-slate-400">Looking up container...</p>
	...
	{:else if error}
		...
		<h1 class="mt-6 text-xl font-bold text-slate-900 dark:text-white">Container Not Found</h1>
		...
		<div class="mt-6 flex gap-3">
			...
			<a
				href="/"
				class="rounded-lg border border-slate-300 dark:border-slate-600 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50"
			>
				Go Home
			</a>
		</div>
