<script lang="ts">
	...
	import { LocationCard, Card } from '$lib/components';
...
{#if $user}
	<div class="space-y-8">
		...
		<div>
			...
			<p class="mt-1 text-slate-500">Here's an overview of your storage.</p>
		</div>
		...
		<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
			<Card>
				<div class="flex items-center gap-4">
					...
					<div>
						<p class="text-2xl font-bold text-slate-900">{locationList.length}</p>
		...
		<div>
			<div class="mb-4 flex items-center justify-between">
				<h2 class="text-lg font-semibold text-slate-900">Your Locations</h2>
				<a href="/locations" class="text-sm text-primary-600 hover:text-primary-700">View all</a>
			</div>
