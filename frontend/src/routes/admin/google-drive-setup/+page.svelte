...
<div class="mx-auto max-w-3xl space-y-8 p-6">
	...
	<div>
		...
		<h1 class="text-2xl font-bold text-slate-900">Google Drive Setup Guide</h1>
	...
	<section class="rounded-lg border border-red-200 bg-red-50 p-4">
		...
		<div class="mt-2 space-y-2 text-sm text-red-800">
			<p>
	...
	<section class="space-y-4">
		...
		<div class="ml-11 space-y-3 text-slate-600">
			<ol class="list-decimal space-y-2 pl-4">
				<li>
					Go to <a href="https://console.cloud.google.com" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:underline">console.cloud.google.com</a>
				</li>
	...
	<section class="space-y-4">
		...
		<div class="ml-11 space-y-3 text-slate-600">
			...
			<h3 class="font-medium text-slate-900 mt-4">Create a Shared Drive:</h3>
			<ol class="list-decimal space-y-2 pl-4">
				<li>Open <a href="https://drive.google.com" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:underline">Google Drive</a> (make sure you're logged into your Workspace account)</li>
			...
			<h3 class="font-medium text-slate-900 mt-4">Add the Service Account as a Member:</h3>
			<ol class="list-decimal space-y-2 pl-4">
				...
				<li>
					...
					<ul class="mt-1 ml-4 list-disc text-sm">
						...
						<li>Copy the service account email (looks like: <code class="bg-slate-100 px-1 rounded">name@project-id.iam.gserviceaccount.com</code>)</li>
					</ul>
				</li>
	...
	<section class="space-y-4">
		...
		<div class="ml-11 space-y-3 text-slate-600">
			<ol class="list-decimal space-y-2 pl-4">
				<li>Go to <a href="/admin" class="text-primary-600 hover:underline">Admin Panel</a> &gt; <strong>Backups</strong> tab</li>
	...
	<section class="space-y-4">
		...
		<div class="space-y-4">
			...
			<div class="rounded-lg border border-slate-200 p-4">
				<h3 class="font-medium text-slate-900">"API not enabled" error</h3>
				<p class="mt-1 text-sm text-slate-600">
					Go back to Google Cloud Console and verify that the Google Drive API is enabled for your project (Step 2).
				</p>
			</div>
			<div class="rounded-lg border border-slate-200 p-4">
				<h3 class="font-medium text-slate-900">"Invalid JSON" error</h3>
				<p class="mt-1 text-sm text-slate-600">
			...
			<div class="rounded-lg border border-slate-200 p-4">
				<h3 class="font-medium text-slate-900">Using a personal Gmail account?</h3>
				<p class="mt-1 text-sm text-slate-600">
